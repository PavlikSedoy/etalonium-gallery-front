...
//     function L(a) { var b = {}; return r.each(a.match(K) || [], function(a, c) { b[c] = !0 }), b } r.Callbacks = function(a) {
...
//     function O(a, b, c) { var d; try { a && r.isFunction(d = a.promise) ? d.call(a).done(b).fail(c) : a && r.isFunction(d = a.then) ? d.call(a, b, c) : b.call(void 0, a) } catch (a) { c.call(void 0, a) } } r.extend({
//         Deferred: function(b) {
//             var c = [
...
//             if (d = "data-" + b.replace(Y, "-$&").toLowerCase(), c = a.getAttribute(d), "string" == typeof c) { try { c = Z(c) } catch (e) {} W.set(a, b, c) } else c = void 0;
//         return c
//     }
...
//     function Ja(a, b, c) { for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++) c || 1 !== d.nodeType || r.cleanData(ma(d)), d.parentNode && (c && r.contains(d.ownerDocument, d) && na(ma(d, "script")), d.parentNode.removeChild(d)); return a } r.extend({
...
//     function nb(a) { return a.getAttribute && a.getAttribute("class") || "" } r.fn.extend({
//         addClass: function(a) {
...
//     function Sb(a) { return r.isWindow(a) ? a : 9 === a.nodeType && a.defaultView } r.offset = {
...
$(document).ready(function() {
    ...
    $(".odessa-event-button").click(function() { 
    	$(".odessa-event-modal").fadeIn();
        $(".events-modal").fadeIn();
    });

    $(".premier-event-button").click(function() { 
    	$(".premier-event-modal").fadeIn();
        $(".events-modal").fadeIn();
    });

    $(".olerom-event-button").click(function() { 
    	$(".olerom-event-modal").fadeIn();
        $(".events-modal").fadeIn();
    });
...
$(window).load(function() {
  ...
  $("#preloader-overlayer").delay(2000).fadeOut("slow");
})
